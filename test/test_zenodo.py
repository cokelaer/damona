...
deposit = {'conceptdoi': '10.5072/zenodo.960007',
 ...
 'files': [{'checksum': '4949d8da803d970e74de7ce898ed3c6b',
   'filename': 'art_2.5.8.img',
   'filesize': 339525632,
   'id': 'de1a2781-7d3f-4322-97d4-52fcd9df29c0',
   'links': {'download': 'https://sandbox.zenodo.org/api/files/7b677fd2-2722-4f17-a270-3cef204f9858/art_2.5.8.img',
    'self': 'https://sandbox.zenodo.org/api/deposit/depositions/960008/files/de1a2781-7d3f-4322-97d4-52fcd9df29c0'}}],
 'id': 960008,
 'links': {'badge': 'https://sandbox.zenodo.org/badge/doi/10.5072/zenodo.960008.svg',
 ...
 'metadata': {'access_right': 'open',
  ...
  'creators': [{'affiliation': 'Institut Pasteur',
